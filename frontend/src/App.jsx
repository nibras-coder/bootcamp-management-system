...
function SocialIcon({ type }) {
  const paths = {
    ...
    youtube: (
      <path d="M21.7 7.2a3 3 0 0 0-2.1-2.1C17.9 4.6 12 4.6 12 4.6s-5.9 0-7.6.5a3 3 0 0 0-2.1 2.1C1.8 8.9 1.8 12 1.8 12s0 3.1.5 4.8a3 3 0 0 0 2.1 2.1c1.7.5 7.6.5 7.6.5s5.9 0 7.6-.5a3 3 0 0 0 2.1-2.1c.5-1.7.5-4.8.5-4.8s0-3.1-.5-4.8ZM10 15.7V8.3l6.2 3.7-6.2 3.7-6.2-3.7Z" />
    ),
...
function Footer() {
  const socials = [
    ...
    [
      "instagram",
      "Instagram",
      "https://instagram.com/astumsj",
    ],
    [
      "facebook",
      "Facebook",
      "https://facebook.com/astumsj",
    ],
    [
      "youtube",
      "YouTube",
      "https://youtube.com/@astumsj",
    ],
    [
      "x",
      "X",
  ...
  return (
    <footer className="footer">
      ...
      <div className="container footer-grid">
        ...
        <div className="footer-main">
          ...
          <p>
            ...
            bootcamp activities, track progress
            and grow together — run by Adama
      ...
      <div className="container footer-bottom">
        ...
        <span>
          Made by Nibras Coders
        </span>

        <span>
          ASTU MSJ Bootcamp — Learn.
          Build. Grow Together.
        </span>
      ...
      <section className="hero">
        ...
        <div className="container hero-inner">
          ...
          <div className="hero-copy">
            ...
            <div className="arabic text-gray-600">
            ...
            <p>
              ...
              manage bootcamp activities,
              track your progress and achieve
              success together with your
...
function AboutPage() {
  ...
  return (
    <PageShell
      ...
      intro="ASTU MSJ Bootcamp is a student-run programme by the Muslim Students Jemea of Adama Science and Technology University. We help students gain practical tech skills through mentor-led, project-based cohorts."
    >
      ...
      <div className="two-col">
        ...
        <article className="info-card">
          ...
          <p>
            To equip every ASTU student
            with practical, job-ready
            technology skills in an
            environment that nurtures both
            deen and dunya, and to make
            quality tech education accessible
            to all our members free of charge.
          </p>
        ...
        <article className="info-card">
          ...
          <p>
            A generation of Muslim students
            from ASTU who build useful
            software, serve their community
            and lead with excellence in the
            technology industry.
          </p>
